...
class OpenClaw(BaseInstalledAgent):
    ...
    def populate_context_post_run(self, context: AgentContext) -> None:
        ...
        ev_in, ev_out, ev_cached, ev_cost, ev_saw, ev_n = self._accumulate_usage_from_events(
            events_path
        )
        se_in, se_out, se_cached, se_cost, se_saw, se_n = self._accumulate_usage_from_sessions(
            sessions_dir
        )
